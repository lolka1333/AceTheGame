...
## Итоговый результат
- **До исправлений**: Частые вылеты при выборе процесса и сканировании памяти, ошибки при all_read_write сканировании, зависание UI при attach
- **После исправлений**: Стабильная работа с корректной обработкой ошибок, понятными сообщениями для пользователя, поддержкой интенсивных операций и отзывчивым UI
