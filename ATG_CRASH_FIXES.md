...
## Итоговый результат
- **До исправлений**: Частые вылеты при выборе процесса и сканировании памяти, ошибки при all_read_write сканировании
- **После исправлений**: Стабильная работа с корректной обработкой ошибок, понятными сообщениями для пользователя и поддержкой интенсивных операций
