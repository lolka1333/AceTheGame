...
**Проблема**: После завершения сканирования происходили вылеты при попытке получить количество совпадений (GetMatchCount), когда соединение с сервером уже было потеряно.
